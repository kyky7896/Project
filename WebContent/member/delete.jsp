...
<%
	...
	//로그인 세션 제어
	if (id == null) {
		System.out.println("삭제페이지 -> 로그인페이지");
					...
					<!-- 부트스트랩 그리드 시스템  
						https://poiemaweb.com/bootstrap-grid-system  -->
							<div class="col-md-12 text-center">
								<h1>Confirm member</h1>
							</div>
						</div>
						<form action="deletePro.jsp" method="post" name="delete" >
							...
							<div class="col-md-12 text-center ">
								<input type="submit"
									class=" btn btn-block mybtn btn-primary tx-tfm" value="탈퇴하기"> 
							</div>
							<div class="col-md-12">
								<div class="login-or">
									<hr class="hr-or">
